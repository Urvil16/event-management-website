<div class="col-md-4 about-wthree-grids">
					<div class="offic-time">
						...
						<div class="time-bottom">
							<a href="IEEE.php"><h5> IEEE </h5></a>
							<a href="hecathon.php"><h5> Hackathon  </h5></a>
							<a href="Google.php"><h5> Google </h5></a>
							...
							<ul class="rslides" id="slider5">
								...
								<li>
									<div class="testi-slider">
										...
										<p>I am very thankful to EventAlly. It's work is prefect and beautiful. </p>
										<div class="testi-subscript">
