		...
		<div class="container">
			...
			<div class="grid_3 grid_5"><br /><br/>
				<div class="but_list w3layouts">
					<h1>
						<a href="gallery.php"><span class="label label-default">IEEE</span></a>
						<a href="hecathon_gal.php"><span class="label label-primary">Hackathon </span></a>
						<a href="Google_gal.php"><span class="label label-success">Google</span></a>
			...
			<div class="gallery-grids-top">
				...
				<div class="col-md-3 gallery-grid">
						...
						<a href="book_hecathon.php?id=<?php echo $row['id']; ?>"><?php echo "<input type='button' value='BOOK NOW' class='btn my'/>" ;?></a><br />
					</div>
					<?php } ?>
