<?php
	...
	if(isset($_REQUEST['submit']))
	{
        ...
        $stmt = mysqli_prepare($con, "UPDATE birthday SET img=?, nm=?, price=? WHERE id=?");
        mysqli_stmt_bind_param($stmt, "ssii", $fnm, $nm, $pr, $id);
...
<div class="codes">
<div class="container"> 
<h3 class='w3ls-hdg' align="center">EDIT HACKATHON</h3>
<div class="grid_3 grid_4">
				<div class="tab-content">
					...
					<input type="submit" name="submit" class="btn" value="UPDATE"> <input type="button" value="DISPLAY" class="btn my" onClick="javascript:location.href='hecathon_disp.php'"/>
					</div>
					</form>
					</div>
				</div>
